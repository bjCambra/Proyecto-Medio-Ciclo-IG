...
<div class="contenedor_all">
    ...
    <?php
                           ...
                           $id=$_POST['CI'];
                           $coincidencia = mysqli_query($conection,"SELECT * FROM certificados_medicos WHERE CI_Estudiante ='$id'");                                
        ...
        <tbody id="datos">
            <?php
               ...
               <tr>
                 ...
                 <td><?php echo $row['Descripcion_Certificado']; ?></td>
                 <td><?php echo $row['Institucion_Emisora']; ?></td>
